...
char catagories[][20]={" First Semester"," Second Semester"," Third Semester"," Fourth Semester"," Fifth Semester"," Sixth Semester"," seventh Semester","Eighth Semester"};
...
gotoxy(20,7);
printf("\xDB\xDB\xDB\xDB\xB2 1. First Semester");
gotoxy(20,9);
printf("\xDB\xDB\xDB\xDB\xB2 2. Second Semester");
gotoxy(20,11);
printf("\xDB\xDB\xDB\xDB\xB2 3. Third Semester");
gotoxy(20,13);
printf("\xDB\xDB\xDB\xDB\xB2 4. Fourth Semester");
gotoxy(20,15);
printf("\xDB\xDB\xDB\xDB\xB2 5. Fifth Semester");
gotoxy(20,17);
printf("\xDB\xDB\xDB\xDB\xB2 6.Sixth Semester");
gotoxy(20,19);
printf("\xDB\xDB\xDB\xDB\xB2 6.Seventh Semester");
gotoxy(20,21);
printf("\xDB\xDB\xDB\xDB\xB2 6.Eighth Semester");
gotoxy(20,23);
...
fclose(fp);
remove("Gaurav.dat");
rename("test.dat","Gaurav.dat"); //copy all item from temporary file to fp except that
fp=fopen("Gaurav.dat","rb+");    //we want to delete
if(findbook=='t')
{
gotoxy(10,10);
